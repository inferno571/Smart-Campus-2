/**
 * Environment variables configuration with hardcoded Groq API key
 */
...
export const env = {
  // Hardcoded API key
  GROQ_API_KEY: "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",
  ...
  // School config
  NEXT_PUBLIC_DEFAULT_SCHOOL_NAME: "IIT Delhi",
  NEXT_PUBLIC_DEFAULT_SCHOOL_SHORT_NAME: "IITD",
}